...
provide the who/what/which parts, respectively, so a permission can be viewed as
a triplet:
...
and the permission itself. Permissions are currently restricted to apply to
datasets only, though this might be extended in the future. For now, the
